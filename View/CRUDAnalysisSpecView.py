class CRUDAnalysisSpecView:
    def CRUDAnalysisSpecView(self):
        pass
    def renderView(self):
        print "MLPP:  Create, Delete, Update An Analysis Specification"
        print "1. Create an Analysis Specification Name"
